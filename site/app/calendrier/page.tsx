...
const T = {
  fr: {
    ...
    days: [
      ...
      { day: 'Mardi', events: [{ time: '19h', label: 'Mardi Heure De la Décision (HDD)', sub: '' }, { time: '0h – 3h', label: 'Veillée dénomination', sub: '' }] },
      ...
      { day: 'Vendredi', events: [{ time: '19h', label: 'Vendredi de Toutes les Possibilités (VTP)', sub: '1×/2 semaines' }] },
  ...
  en: {
    ...
    days: [
      ...
      { day: 'Tuesday', events: [{ time: '7 PM', label: 'Tuesday Hour of Decision (HDD)', sub: '' }, { time: '12 AM – 3 AM', label: 'Denomination watch', sub: '' }] },
      ...
      { day: 'Friday', events: [{ time: '7 PM', label: 'Friday of All Possibilities (VTP)', sub: 'Bi-weekly' }] },
