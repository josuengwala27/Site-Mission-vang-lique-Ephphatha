...
const T = {
  fr: {
    ...
    projectAddress: '27 rue des Ormes, 31520 Ramonville',
    projectEnd: ', actuellement en travaux. Ce bâtiment deviendra un centre spirituel pour la prière, la formation et l\'envoi. Le siège social se trouve au 27 rue des Ormes. Les cultes ont lieu au 14 rue Sirven, 31100 Toulouse.',
  ...
  en: {
    ...
    projectAddress: '27 Ormes Street, 31520 Ramonville',
    projectEnd: ', currently under construction. This building will become a spiritual centre for prayer, training and sending. The registered office is at 27 Ormes Street. Services are held at 14 Sirven Street, 31100 Toulouse.',
