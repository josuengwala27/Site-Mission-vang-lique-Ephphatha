...
const T = {
  fr: {
    ...
    tuesdayText: 'Mardi Heure De la Décision (HDD) – soirée pour poser des choix spirituels clairs.',
    ...
    fridayText: 'Vendredi de Toutes les Possibilités (VTP) – soirée de foi et de percée.',
    ...
    addressText2: 'Le siège social se trouve au',
    addressPlace2: '27 rue des Ormes, 31520 Ramonville',
  ...
  en: {
    ...
    tuesdayText: 'Tuesday Hour of Decision (HDD) – an evening to make clear spiritual choices.',
    ...
    fridayText: 'Friday of All Possibilities (VTP) – an evening of faith and breakthrough.',
    ...
    addressText2: 'Our registered office is at',
    addressPlace2: '27 Ormes Street, 31520 Ramonville',
