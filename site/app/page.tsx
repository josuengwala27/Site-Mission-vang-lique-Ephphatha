...
const T = {
  fr: {
    ...
    w1: "Mardi Heure De la Décision (HDD)", w2: "Culte d\u2019affermissement", w3: "Vendredi de Toutes les Possibilités (VTP)",
  ...
  en: {
    ...
    w1: "Tuesday Hour of Decision (HDD)", w2: "Strengthening Service", w3: "Friday of All Possibilities (VTP)",
